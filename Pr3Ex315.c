...
int main(){
    ...
    unsigned i, *numCaminsDisponibles;
    estructuracami *cami;
    aresta *larestes;
    ...
    // Bucle trobar els camins a partir de tots els vertexs
    (*numCaminsDisponibles) = 0;
    for (i=0;i<numVertex;i++){
        cami->llistaNodesVist[0] = i;
        CalcularCaminDonatOrigen(i, numArestes, larestes, cami, numCaminsDisponibles);
    }
    

    printf("La funcio ha trobat %u camins disponibles en total", *numCaminsDisponibles);
    printf("\n");
